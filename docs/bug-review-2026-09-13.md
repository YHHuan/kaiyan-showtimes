...
- 真善美同時有兩個裸名，以各自已查證的電影介紹網址辨識真人／動畫；分別明載是枝裕和與押山清高，不靠片名猜測。
...
- [真善美《驀然回首》動畫版介紹](https://wonderful.movie.com.tw/movie/inner?id=2396)、[真人版介紹](https://wonderful.movie.com.tw/movie/inner?id=2406)
...
- `node --test tests/identity.mjs tests/sources.mjs tests/coverage.mjs`：18 項來源、作品比對、實際建站及覆蓋回歸測試。
