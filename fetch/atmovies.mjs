...
const ARTHOUSE = {
  ...
  t02a08: { name: '誠品電影院', area: '台北市', region: 'a02' }, // 官網 arthouse.eslite.com 是舊式 ASP.NET WebForms，純 GET 抓不到場次時間
  t02d20: { name: '光點台北電影院', area: '台北市', region: 'a02' }, // 官網 spot.org.tw 場次表整月是一張 JPG 圖片，無文字

  // -- 使用者指名的其餘藝文館 --
  t02b07: { name: '真善美戲院', area: '台北市', region: 'a02' }, // 官網 wonderful.movie.com.tw 場次靠 AJAX 動態載入，curl 拿不到時間
  t02e22: { name: '國家電影及視聽文化中心', area: '新北市', region: 'a02' }, // 官網 tfai.org.tw 被 Cloudflare Managed Challenge 擋下（403）
  // 注意：TFAI 開眼頁面本身也只有一張場次看板圖（<div class="theaterboard"><img.../></div>），
  // 沒有逐場次文字，實測會是 0 筆——留在白名單是誠實反映「兩邊都抓不到」，不是漏解析。

  // -- 開眼「台北二輪▼」分區，範例即景美佳佳（使用者原話） --
  t02f05: { name: '景美佳佳戲院', area: '台北市', region: 'a02' },
  ...
  t02a03: { name: '微風影城', area: '台北市', region: 'a02' }, // 2022 起微風集團自營，非國賓/威秀旗下
  t02a05: { name: '總督影城', area: '台北市', region: 'a02' }, // 獨立單館，總督影城事業股份有限公司
  t02a06: { name: '哈拉影城', area: '台北市', region: 'a02' }, // 哈拉生活集團，2008年起脫離秀泰代管，獨立經營
  t02c01: { name: '百老匯影城公館店', area: '台北市', region: 'a02' }, // 獨立品牌，僅公館+新竹竹北兩館；官網 Vue.js 動態渲染，curl 抓不到場次
  t02e03: { name: '新莊鴻金寶麻吉影城', area: '新北市', region: 'a02' }, // 萬念福開發事業，附屬鴻金寶麻吉廣場的獨立單館
  t02e04: { name: '三重天台戲院', area: '新北市', region: 'a02' }, // 天台廣場獨立單館
};
...
const VIESHOW = {
  t02a01: { name: '台北信義威秀', area: '台北市', region: 'a02' },
  t02a11: { name: 'MUVIE CINEMAS台北松仁威秀', area: '台北市', region: 'a02' },
  t02a12: { name: '台北南港LaLaport威秀影城', area: '台北市', region: 'a02' },
  t02b14: { name: '台北京站威秀', area: '台北市', region: 'a02' },
  t02b08: { name: '台北西門威秀影城', area: '台北市', region: 'a02' },
  t02e07: { name: '板橋大遠百威秀影城', area: '新北市', region: 'a02' },
  t02e12: { name: '林口三井OUTLET威秀影城', area: '新北市', region: 'a02' },
  t02e20: { name: '中和環球威秀影城', area: '新北市', region: 'a02' },
  t02e21: { name: '新店裕隆城威秀影城', area: '新北市', region: 'a02' },
  t03308: { name: '桃園統領威秀影城', area: '桃園市', region: 'a03' },
  t03317: { name: '桃園桃知道威秀影城', area: '桃園市', region: 'a03' },
  t03505: { name: '新竹大遠百威秀影城', area: '新竹市', region: 'a35' },
  t03508: { name: '新竹巨城威秀影城', area: '新竹市', region: 'a35' },
  t04402: { name: '台中老虎城威秀', area: '台中市', region: 'a04' },
  t04407: { name: '台中大遠百威秀影城', area: '台中市', region: 'a04' },
  t04409: { name: '台中iFG遠雄廣場威秀影城', area: '台中市', region: 'a04' },
  t06609: { name: '台南大遠百威秀影城', area: '台南市', region: 'a06' },
  t06610: { name: '台南南紡威秀影城', area: '台南市', region: 'a06' },
  t06611: { name: '台南FOCUS威秀影城', area: '台南市', region: 'a06' },
  t07703: { name: '高雄大遠百威秀影城', area: '高雄市', region: 'a07' },
};
...
const SKCINEMAS_BACKUP = {
  t02b05: { name: '台北新光影城', area: '台北市', region: 'a02' },
  t02d04: { name: '台北天母新光影城', area: '台北市', region: 'a02' },
  t03315: { name: '桃園新光影城', area: '桃園市', region: 'a03' },
  t04401: { name: '台中新光影城', area: '台中市', region: 'a04' },
  t06607: { name: '台南新光影城', area: '台南市', region: 'a06' },
};
...
for (const [code, { name, area, region }] of Object.entries(CINEMAS)) {
